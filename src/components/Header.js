...
const Header = () => {
  ...
  // </button>
  return (
    <Navbar className="mx-auto dark:text-white text-black px-4 py-2 lg:px-8 lg:py-4 dark:border-hidden border-hidden relative z-50">
      <div className="container mx-auto flex flex-wrap lg:items-center justify-between text-blue-gray-900">
        ...
        <div className="hidden items-center gap-x-2 lg:flex ">
          ...
          <Button size="sm" className="rounded-lg dark:text-black dark:bg-white text-white bg-black">
            Search
          </Button>
          <button onClick={changeTheme} className="rounded-lg ml-2">
