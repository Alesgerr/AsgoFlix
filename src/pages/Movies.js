  ...
  const [page, setPage] = useState(1);
   ...
   const fetchData = async () => {
      try {
        ...
        // Filmleri 0 reytingli olanlar ve diğerleri olarak iki gruba ayır
        ...
        // Diğer filmleri sırala
        const sortedMovies = otherMovies.sort((a, b) => {
        ...
        // 0 reytingli olanları diğer filmlerin sonuna ekle
        const finalMovies = [...sortedMovies, ...zeroRatingMovies];
  
        setMovieData(finalMovies);
      } catch (error) {
